...
},{"buffer":32,"fs":30}],28:[function(require,module,exports){
const axios = require("axios");
const pitchInfo = require("./assets/pitchInfo.json");
...
const getMidi = async () => {
  const result = await axios.get("./src/assets/006-b-flat-waltz-piano-v2.mid", {
...
const getAudio = async () => {
  const result = await axios.get("./src/assets/006-b-flat-waltz-piano-v2.mp3", {
    responseType: "arraybuffer",
  });
  const { data } = result;
...
},{"./assets/pitchInfo.json":29,"axios":1,"midi-player-js":27}],29:[function(require,module,exports){
module.exports={
  "C": {
    "number": 0,
    "color": [66, 84, 245]
